...
# juju bootstrap --bootstrap-series=focal --bootstrap-constraints tags=juju juju bootstrap --bootstrap-series=bionic --bootstrap-constraints tags=juju --bootstrap-constraints mem=4096 maas-one maas-onemaas-one maas-one
