...
juju deploy --config config/glance.yaml -n 3 --to lxd:0,lxd:1,lxd:2 cs:~openstack-charmers-next/glance glance
juju deploy --config config/glance.yaml cs:~openstack-charmers-next/hacluster glance-hacluster
