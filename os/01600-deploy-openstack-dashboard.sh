...
juju deploy --config config/openstack-dashboard.yaml -n 3 --to lxd:0,lxd:1,lxd:2 cs:~openstack-charmers-next/openstack-dashboard openstack-dashboard
juju deploy --config config/openstack-dashboard.yaml cs:~openstack-charmers-next/hacluster openstack-dashboard-hacluster
